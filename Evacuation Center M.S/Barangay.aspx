...
<%@ Page Title="" Language="C#" MasterPageFile="~/mainbar.Master" AutoEventWireup="true" CodeBehind="Barangay.aspx.cs" Inherits="Evacuation_Center_M.S.Barangay" %>
                        ...
                        <div class="row">
                           <div class="col-md-3">
                              ...
                              <div class="col-md-12">
                                  ...
                                  <asp:Button ID="Button2" runat="server" type="submit" class="btn btn-danger" Text="Cancel" OnClick="Button2_Click" />
                         ...
                         try
                         {
                             ...
                             if (dr.HasRows)
                             {
                                 while (dr.Read())
                                 {
                                     ...
                                     Response.Write("<TD class='text-right'> <a href='update_Barangay.aspx?Reffno="+ dr.GetValue(0).ToString()+"' class='btn btn-sm btn-success' class='fa fa-edit'><i class='fa fa-edit'' ></i> "+
